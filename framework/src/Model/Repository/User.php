    ...
    private function getDataFromSource(array $search = [])
    {
        ...
        $dataSource = [
            ...
            [
                ...
                'login' => 'testok',
                'password' => '$2y$10$vQvuFc6vQQyon0IawbmUN.3cPBXmuaZYsVww5csFRLvLCLPTiYwMa', // testing
                'role' => $test,
            ...
            [
                ...
                'name' => "student",
                'login' => 'student',
                'password' => '$2y$10$XTMIPBr2DL9gWctkIi7yfu2oEWMRxdwJQvNuG87516xtW3Z3uLsq6', //studtester
                'role' => $user,
                'discount' => self::$premiumDiscount
            ]
        ];
